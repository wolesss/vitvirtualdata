...
order_customer_payment_df = pd.read_csv("https://github.com/wolesss/vitvirtualdata/blob/main/Dashboard/order_customer_payment.csv")

order_product_df = pd.read_csv("https://github.com/wolesss/vitvirtualdata/blob/main/Dashboard/order_product.csv")

order_payment_df = pd.read_csv("https://github.com/wolesss/vitvirtualdata/blob/main/Dashboard/order_payment.csv")
...
with st.sidebar:
    ...
    st.image("https://github.com/wolesss/vitvirtualdata/blob/main/Dashboard/Logo.png")
