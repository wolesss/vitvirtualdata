...
order_customer_payment_df = pd.read_csv("order_customer_payment.csv")

order_product_df = pd.read_csv("order_product.csv")

order_payment_df = pd.read_csv("order_payment.csv")
...
with st.sidebar:
    ...
    st.image("D:\Downloads\LAIN-LAIN\Dicoding\Dicoding\Submission\Dashboard\Logo.png")
